          ...
          <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <a type="button" href="{{ route('expert') }}" class="btn btn-info">Back</a>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('nip') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('nip') ? ' is-invalid' : '' }}" name="nip" id="input-nip" type="text" placeholder="{{ __('NIP') }}" value="{{ old('nip', auth()->user()->expert->nip) }}"/>
                      @if ($errors->has('nip'))
