    ...
    <div class="col-sm-2">
        <div class="input-group">
            <input class="form-control" input type="text" name="hvps_v_{{ $namaKolom }}"
                id="input_HVPS_V_{{ $namaKolom }}" placeholder="{{ __('HVPS_V') }}" value="{{ old("hvps_v_$namaKolom") }}" />
    ...
    <div class="col-sm-2">
        <div class="input-group">
            <input class="form-control" input type="text" name="hvps_i_{{ $namaKolom }}"
                id="input_HVPS_I{{ $namaKolom }}" placeholder="{{ __('HVPS_I') }}" value="{{ old("hvps_i_$namaKolom") }}" />
            <div class="input-group-append">
    ...
    <div class="col-sm-2">
        <div class="input-group">
            <input class="form-control" input type="text" name="mag_i_{{ $namaKolom }}"
                id="input_Mag_I{{ $namaKolom }}" placeholder="{{ __('Mag_I') }}" value="{{ old("mag_i_$namaKolom") }}" />
            <div class="input-group-append">
