@extends('layouts.app', ['activePage' => 'expert-management', 'titlePage' => __('Edit FSE')])
        ...
        <div class="card">
          ...
          <div class="card-body">
              <div class="table-responsive">
                <form action="/editExp/{{ $experts->expert_id }}" method="POST">
                    @csrf
                    @method('put')
                      ...
                      <div class="form-group">
                        ...
                        <br>
                        <input type="text" class="form-control @error('nip') is-invalid @enderror" id="nip" name="nip" placeholder="Input NIP Number" value="{{ $experts->nip }}">
                      ...
                      <div class="form-group">
                        ...
                        <br>
                        <input type="text" class="form-control @error('expert_company') is-invalid @enderror" id="expert_company" name="expert_company" placeholder="Input the Expert Company" value="{{ $experts->expert_company }}">
